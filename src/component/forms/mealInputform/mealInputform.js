...
export default class mealInputform extends React.Component {
	...
	render() {
		console.log(this.props.currentMealInfo[0]);
			...
			<section className="meal_entry">
				<form className="user__carb-form" onSubmit={this.getMealsAndCalories}>
					<div>
						...
						<input placeholder="Meal" type="text" name="breakfast_food" id="breakfast_food" defaultValue={breakfast_food}/>
						<label htmlFor="breakfast_calories">Calories</label>
						<input placeholder="Calories" type="text" name="breakfast_calories" id="breakfast_calorie" defaultValue={breakfast_calories} />
						<button type="submit">Log</button>
					</div>
					<div>
						<label htmlFor="lunch_food">Lunch</label>
						<input placeholder="Meal" type="text" name="lunch_food" id="lunch_food" defaultValue={lunch_food} />
						<label htmlFor="lunch_calories">Calories</label>
						<input placeholder="Calories" type="text" name="lunch_calories" id="lunch_calorie" defaultValue={lunch_calories}/>
						<button type="submit">Log</button>
					</div>
					<div>
						<label htmlFor="dinner_food">Dinner</label>
						<input placeholder="Meal" type="text" name="dinner_food" id="dinner_food" defaultValue={dinner_food}/>
						<label htmlFor="dinner_calories">Calories</label>
						<input placeholder="Calories" type="text" name="dinner_calories" id="dinner_calorie" defaultValue={dinner_calories} />
						<button type="submit">Log</button>
					</div>
				</form>
			</section>
